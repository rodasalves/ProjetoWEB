...
mysqli_set_charset($conn,'UTF8');
    ...
    if(isset($_POST['submeter'])){  
           ...
           if($_POST['email']!=""){
               ...
               $sql_email=sprintf("select email from registo;");
               $res_email=mysqli_query($conn,$sql_email);

               while($num_email=mysqli_fetch_array($res_email)){

                   if($_POST['email']==$num_email['email']){
                       
                       
                       $numero=rand(10000,99999);

                       $enviar=$numero.date('Y-m-d').date('H:i:s');

                       $enviar=md5($enviar);  
 
                       $sql_atualiza=sprintf("update registo set chave='%s' where email='%s';",$enviar,$_POST['email']);
                       ...
                       <body>
                       <p>Este email contém um link</p>
                       <p>LINK: <a href=localhost/ProjetoWEB/esc_pass.php> $enviar</a> </p>
                       </body>
                       ...
                       // More headers
                       $headers .= 'From: <gamesforever236@gmail.com>' . "\r\n";
							...
							<div class="billing checkout_box">
								...
								<div class="checkout_form_container">
									    <form method="post" enctype="multipart/form-data">                    
                                            ...
                                            <div class="col-md-6"> 
                                                <div>
											         <!-- Email -->
											             ...
											             <input type="text" name="email" id="checkout_company" class="checkout_input" required="required">
                                                </div>	
                                            </div>
                                            ...
                                            <div class="row">
                                            <div class="col-md-12">                            
                                            <button type="submit" name="submeter" class="checkout_button" >Enviar Proposta</button>      
