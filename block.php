					...
					<div class="col">
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="billing checkout_box">
								<div class="checkout_title">Bloqueado</div>
								<div class="checkout_form_container">
									<form action="#" id="checkout_form" class="checkout_form" method="post">
                                        <p>
                                            A sua conta esta bloqueada por ter violado as politicas da Loja GamesForever
                                         </p>
                                            
                                        <input type="button" name="logout" onclick="javascript:document.location='logout.php'" class="checkout_button" value="Voltar à Loja">
									</form>
								</div>
							</div>
						</div>
