...
<?php
            ...
            $sql_lista=sprintf("select * from categorias order by id;");
            $res_lista=mysqli_query($conn,$sql_lista);

            if ($num_consulta['nivel']!=5){
                
                $sql_cate=sprintf("select * from categorias where nivel!=2;");
                ...
                $sql_cate=sprintf("select * from categorias;");
                $res_cate=mysqli_query($conn,$sql_cate);
        ...
        <?php
                    header('location:gerir_cate.php');
                }
                
            }
        if(isset($_POST['confirmar'])){
             $sql_confirma=sprintf("update categorias set categoria='%s',codigo='%s',nivel='%s' where id=%d;",$_POST['categoria'],$_POST['codigo'],$_POST['nivel'],$_SESSION["id"]);            
		...
		<div class="section_container">
					...
					<div class="col">
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="billing checkout_box">
								<div class="checkout_title">Categorias Disponiveis</div>
                ...
                <?php
                        ...
                        <form method="post">
                           ...
                           <tr>
                               ...
                               <td><?php echo $reg_lista['categoria']; ?></td>
                               <td><?php echo $reg_lista['nivel']; ?></td>
            ...
            <?php 
                ...
                if (isset($_POST['editar'])){
                    ...
                    $sql_id=sprintf("select * from categorias where id=%d;",$_POST['id']);
                ...
                <div class="row justify-content-center">
						<form class="col-lg-9" method="post" enctype="multipart/form-data">
						  ...
						  <div class="form-group">
						    ...
						    <input name="categoria" type="text" class="form-control" value="<?php echo $num_id['categoria'];  ?>">
						  </div>
						  <div class="form-group">
						    <label for="codigo">Codigo</label>
						    <input name="codigo" type="text" class="form-control" value="<?php echo $num_id['codigo'];  ?>">
						  </div>
                          <div class="form-group">
						    <label for="nivel">Nível</label>
						    <input name="nivel" type="text" class="form-control" value="<?php echo $num_id['nivel'];  ?>">
						  </div>
