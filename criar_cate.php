					...
					<div class="col">
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="billing checkout_box">
								<div class="checkout_title">Criar Categorias</div>
								<div class="checkout_form_container">
									<form action="#" id="checkout_form" class="checkout_form" method="post">
                                            ...
                                            <div class="row">
                                            <div class="col-md-12">                            
                                            <button type="submit" name="criar" class="checkout_button" >Criar</button>      
        ...
        <?php
            ...
            $codigo=$_POST['codigo'];
                ...
                if ($nome!=""){
                    ...
                    $sql_insere=sprintf("insert into categorias (categoria,codigo) values ('%s', '%s');",$nome, $codigo);
            ...
            ?>
                    ...
                    <script type="text/javascript">
                        <!--
                        var answer = confirm("EXISTEM DADOS EM BRANCO!");
                        if (!answer){
                        window.location = "GamesForever";
                        }
                        //-->
